...
| Field                                           | Type                      | Notes                                                                                                                                                                                                                                                                                                               |
| ----------------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `is_smart_button`                               | boolean                   | Optional. Only set this on a blueprint whose entire job is activating a scene from a button press (the `scene_*` family). Do not set it just because a blueprint happens to be triggered by a smarli. smart button or relay — the flag is about what the blueprint _does_, not what triggers it.                    |
